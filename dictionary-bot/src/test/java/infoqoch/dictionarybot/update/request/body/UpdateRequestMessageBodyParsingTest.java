...
class UpdateRequestMessageBodyParsingTest {
    ...
    void resolve_type() throws JsonProcessingException {
        ...
        assertType(chat_json, UpdateDataType.CHAT);
        ...
        assertType(document_json, UpdateDataType.DOCUMENT);
        ...
        assertType(photo_json, UpdateDataType.PHOTO);
    }

    private void assertType(String json, UpdateDataType type) {
        UpdateRequest wrapper = jsonToUpdateWrapper(json);
        assertThat(wrapper.updateDataType()).isEqualTo(type);
    }
