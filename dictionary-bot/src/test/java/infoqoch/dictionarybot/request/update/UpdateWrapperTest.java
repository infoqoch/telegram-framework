...
class UpdateWrapperTest {
    ...
    private String mockChatJsonUpdate(String text) {
        return mockChatJsonUpdate(text, 12354235l);
    }

    private String mockChatJsonUpdate(String text, long chatId) {
    ...
    private String mockDocumentJsonUpdate(String caption) {
    ...
    private String mockPhotoJsonUpdate(String caption) {
