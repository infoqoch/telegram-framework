...
public class UpdateDispatcher {
    ...
    public UpdateDispatcher(String packagePath, Map<Class<?>, Object> context) {
        methodResolvers = collectUpdateRequestMappedMethods(packagePath, context);
    }

    private List<UpdateRequestMethodResolver> collectUpdateRequestMappedMethods(String packagePath, Map<Class<?>, Object> context) {
        ...
        List<UpdateRequestMethodResolver> resolvers = new ArrayList<UpdateRequestMethodResolver>();
        Set<UpdateRequestMethodMapper> updateRequestMappers = new HashSet<UpdateRequestMethodMapper>();

        for (Method method : methods) {
            final Object bean = context.get(method.getDeclaringClass());
